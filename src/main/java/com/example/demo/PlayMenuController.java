...
public class PlayMenuController {
    ...
    public void OnLocalButton(ActionEvent event) throws IOException {
            ...
            root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("LocalGameMenu.fxml")));
    ...
    public void OnOnlineButton(ActionEvent event) throws IOException {
